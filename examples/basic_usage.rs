...
use stream_diffusion_rs::basic_nuwe_features::examples;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Run basic examples
    examples::basic_eeg_visualization_example()?;
    examples::realtime_neurofeedback_example()?;
    examples::creative_art_generation_example()?;

    // TODO: Implement full StreamDiffusionRs engine
